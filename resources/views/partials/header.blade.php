							...
							<!-- Brand and toggle get grouped for better mobile display -->
								...
								<div class="collapse navbar-collapse" id="axit-nav">
										<ul class="nav navbar-nav navbar-left">
										 <li class="active"><a href="{{url('/')}}">{{trans('messages.home_page')}}</a></li>
										 <li><a href="{{url('/')}}/about">{{trans('messages.about_page')}}</a></li>
										 <li><a href="{{url('/')}}/services">{{trans('messages.service_page')}}</a></li>
										 <li><a href="{{url('/')}}/works">{{trans('messages.works_page')}}</a></li>
										 <li><a href="{{url('/')}}/news">{{trans('messages.news_page')}}</a></li>
										 <li><a href="{{url('/')}}/contact">{{trans('messages.contact_page')}}</a></li>
										</ul>
