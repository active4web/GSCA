...
function lisiting() {
        ...
        $tables = "clients";
        $config['base_url'] = base_url().'clients/lisiting/'; 
       ...
       // $config['first_url'] = $config['base_url'].'?'.http_build_query($_GET);
        ...
        $datahead['site_setting'] =$this->db->get_where('site_setting')->result();
        ...
        $this->load->view('index/include/head',$datahead);
