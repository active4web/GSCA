...
$this->session->set_userdata(array('controller_curt' => $controller_curt));
$this->session->set_userdata(array('main_curt' => $main_curt));
//echo "dfgfdg".$controller_curt;
  foreach($site_info as $site_info)
  foreach($site_setting as $data)
?>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<div class="dropdown">
											...
											<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
											  <li><a href="<?= DIR?><?= $main_curt;?>/lang_site/ar/"><?= lang("arabic");?></a></li>
											  <li><a href="<?= DIR?><?= $main_curt;?>/lang_site/en/"><?= lang("english");?></a></li>
											</ul>
										  </div>
...
<div style="overflow-x: hidden; background-image:url('<?= base_url()?>uploads/site_setting/header.jpg');position: relative;    background-size: 100% 100%;;"  class="header home top abo">
