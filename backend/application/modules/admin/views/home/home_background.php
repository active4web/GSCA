			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">بنر الخلفية</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
													...
													<div class="portlet light bordered form-fit">
														...
														<?php
															foreach($site_info as $result){
																$slider_background = $result->slider_background;
															}
														?>
														<div class="portlet-body form">
															<!-- BEGIN FORM-->
															<form action="<?php echo $url?>admin/pages/edit_slider_img" class="form-horizontal form-bordered"
														...
														<div class="col-md-3" style="text-align:center"></div>
                                                            ...
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
																			<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
																				<img src="<?=$url;?>uploads/site_setting/<?=$slider_background?>" alt="" /> </div>
																			<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"> </div>
																			<div>
																				<span class="btn default btn-file">
													<span class="fileinput-new">  بنر الهيدر (الطول :1080 والعرض:1920)</span>
