																...
																<div class="form-body">
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> المحتوي </span>
																			<textarea id="about_site_ar" name="goals" id="about_site_ar"><?=$goals;?></textarea>
																	...
																	<div class="form-group">
																		...
																		<span class="help-block"> Context </span>
																			<textarea id="about_site" name="goals_en" id="about_site"><?=$goals_en;?></textarea>
																			<!-- <?php //echo $this->ckeditor->editor("description","description");?> -->
