			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?=$url.'admin/messages/messages_jobs';?>">رسائل الرئيسية</a>
							<i class="fa fa-circle"></i>
						</li>
						<li>
												...
												<div class="portlet box blue ">
													...
													<div class="portlet light bordered form-fit">
														...
														<input type="text"  style="text-align:left;direction:ltr" readonly value="<?php echo $creation_date?>">
																		...
																		<div class="col-md-6" style="text-align:center">
																		<input type="text" readonly value="<?php echo $sname?>" style="text-align:center" >
																		</div>
																	</div>
																		...
																		<input type="text" style="text-align:left;" readonly value="<?php echo $phone?>">
																		</div>
																	</div>
