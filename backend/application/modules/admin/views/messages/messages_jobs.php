							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">رسائل الرئيسية</span>
									</div>
								</div>
								<div class="portlet-body">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										<tbody>
                                        <?php
										 $tt=$this->db->get_where('home_messages')->result();
										 if(count($tt)>0){
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?php echo base_url()?>admin/messages/delete_jobmessage?id=<?= $data->id_message;?>"><i class="fa fa-remove"></i> حذف </a></li>
															<li><a href="<?php echo base_url()?>admin/messages/view_jobmessage?id=<?= $data->id_message;?>"><i class="fa fa-eye"></i>التفاصيل</a></li>
