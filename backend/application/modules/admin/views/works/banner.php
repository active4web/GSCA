			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"> بنر الاعمال </span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
											...
											<div class="tab-pane active" id="tab_5">
												<div class="portlet box blue ">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-gift"></i> بنر الاعمال  </div>
					...
					$about_img = $result->works_banner;
								}
														?>
														<div class="portlet-body form">
															<!-- BEGIN FORM-->
															<form action="<?php echo $url?>admin/works/about_banner" class="form-horizontal form-bordered"
